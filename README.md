...
| --- | --- |
| START_HERE.md | Decision tree — pick your path |
| FIRST_30_MINUTES.md | Hands-on quickstart (30 min) |
| docs/guides/SA_GUIDED_LAB.md | Full 90-minute guided lab |
| docs/guides/TROUBLESHOOTING.md | Common issues and fixes |
| docs/templates/POC_SCORECARD_TEMPLATE.md | Scorecard template |
| docs/templates/POC_CHARTER_TEMPLATE.md | POC charter template |