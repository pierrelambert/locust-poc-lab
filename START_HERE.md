...
**Best for:** First look, internal demos, learning the lab.**Time:** ~30 minutes.**What you'll do:** Spin up OSS Redis + Sentinel in Docker, run a workload, kill the primary, watch failover on Grafana.
...
**Best for:** Showing Redis Enterprise Operator vs. OSS on k8s, internal enablement.**Time:** ~60 minutes.**What you'll do:** Create a k3d cluster, deploy Redis Enterprise Operator and OSS Redis, run workloads, compare failover.
...
**Best for:** Running a real POC on a customer-provided or dedicated VM.**Time:** 90 minutes (guided) or self-paced.**What you'll do:** Run the complete 6-phase guided lab — baseline, primary kill, dashboard review, evidence export, scorecard.
